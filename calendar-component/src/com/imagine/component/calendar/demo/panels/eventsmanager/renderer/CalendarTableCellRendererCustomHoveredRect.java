 ...
 */
public class CalendarTableCellRendererCustomHoveredRect implements CalendarTableCellRenderer {
	
	private CalendarRendererProviderCustom calendarRendererProviderCustom;
	
	public CalendarTableCellRendererCustomHoveredRect(CalendarRendererProviderCustom calendarRendererProviderCustom) {
