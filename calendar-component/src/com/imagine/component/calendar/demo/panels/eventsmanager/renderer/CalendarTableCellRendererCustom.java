 ...
 */
public class CalendarTableCellRendererCustom implements CalendarTableCellRenderer {
	
	private CalendarRendererProviderCustom calendarRendererProviderCustom;
	
	public CalendarTableCellRendererCustom(CalendarRendererProviderCustom calendarRendererProviderCustom) {
