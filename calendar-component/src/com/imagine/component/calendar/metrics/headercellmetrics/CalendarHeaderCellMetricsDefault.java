 ...
 */
public class CalendarHeaderCellMetricsDefault implements CalendarHeaderCellMetrics {
  ...
  public Dimension getPreferredSize(CalendarComponent calendarComponent, CalendarHeaderCellInfo calendarHeaderCellInfo) {
  	...
  	dimension.width = fontMetrics.stringWidth( (String)calendarHeaderCellInfo.getValue() + "  ") + 8;
  	dimension.height = fontMetrics.getAscent() + 8;
