 ...
 */
public class CalendarStatusPanelMetricsTight implements CalendarStatusPanelMetrics {
  ...
  public Dimension getPreferredSize(CalendarComponent calendarComponent, CalendarStatusPanelInfo calendarStatusPanelInfo) {
  	...
  	dimension.width = fontMetrics.stringWidth(calendarStatusPanelInfo.getTodayLabel() + " " + calendarStatusPanelInfo.getNoneLabel() + "  ") + 4;
