 ...
 */
public class CalendarTableCellMetricsTight implements CalendarTableCellMetrics {
  ...
  public Dimension getPreferredSize(CalendarComponent calendarComponent, CalendarTableCellInfo calendarTableCellInfo) {
  	...
  	dimension.width = fontMetrics.stringWidth( (String)calendarTableCellInfo.getValue() + "  ") + 4;
