 ...
 */
public class CalendarSkinStyleForest extends CalendarSkinStyle {
  ...
  public void applyStyle(CalendarSkin calendarSkin)  throws CalendarPropertyException {
    ...
    calendarSkin.setSkinProperty(CalendarSkin.HEADER_CELL_TEXT_COLOR, new Color(189, 209, 173));
    calendarSkin.setSkinProperty(CalendarSkin.HEADER_CELL_FILL_COLOR, new Color(101, 101, 31));
    
    calendarSkin.setSkinProperty(CalendarSkin.WEEK_CELL_TEXT_COLOR, new Color(189, 209, 173));
    calendarSkin.setSkinProperty(CalendarSkin.WEEK_CELL_FILL_COLOR, new Color(101, 101, 31));
