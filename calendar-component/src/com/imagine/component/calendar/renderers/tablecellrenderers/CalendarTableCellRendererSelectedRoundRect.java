 ...
 */
public class CalendarTableCellRendererSelectedRoundRect implements CalendarTableCellRenderer {
	...
	public void paint(Graphics g, CalendarComponent calendarComponent, CalendarTableCellInfo calendarTableCellInfo) {
		...
		g.fillRoundRect(0, 0, calendarTableCellInfo.getWidth(), calendarTableCellInfo.getHeight(), 10,10);
