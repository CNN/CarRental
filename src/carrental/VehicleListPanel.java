...
public class VehicleListPanel extends JPanel {
    ...
    private JTextField descriptionField, licensePlateField, vinField, 
            drivenField;
    private int currentVehicleTypeIndex = -1; //this is for storing the 
    //currently selected choice from the combobox.
    ...
    public VehicleListPanel() {
        ...
        JLabel vehicleTypeLabel, descriptionLabel, licensePlateLabel, vinLabel,
                drivenLabel;
    ...
    public void update() {
        ...
        for (Vehicle vehicle : vehicleList) {
            vehicleTableModel.addRow(new String[]{
                        CarRental.getInstance().requestVehicleType(vehicle.
        ...
        assert (vehicleList.size() == vehicleTableModel.getRowCount()) : 
                "size: " + vehicleList.size() + " rows: " + vehicleTableModel.
                getRowCount();
    ...
    public void filter() {
        ...
        for (Vehicle vehicle : vehicleList) {
            ...
            if (((vehicleTypeCombo.getSelectedIndex() == -1 || 
                    ...
                    contains(licensePlateField.getText().trim().toLowerCase
                    (Locale.ENGLISH))) && //vehicles license plate number 
                    //equals the license plate number given AND
